    ...
    <div class="policy container">
      ...
      <div class="policy-text">
        ...
        <p>
          ...
          безопасности персональных данных, предпринимаемые Замяткиным Сергеем
        ...
        <p>
          ...
          сети интернет по сетевому адресу https://кальяннадом.рф.
        </p>
        <p>
        ...
        <p>
          ...
          kalyannadom@yandex.ru с пометкой «Актуализация персональных данных».
        </p>
        <p>
          ...
          на электронный адрес Оператора kalyannadom@yandex.ru с пометкой «Отзыв
        ...
        <p>
          ...
          Оператору с помощью электронной почты kalyannadom@yandex.ru.
        </p>
        <p>
        ...
        <p>
          ...
          сети Интернет по адресу https://кальяннадом.рф/privacy-policy/.
        </p>
      </div>
    </div>
  </main>
